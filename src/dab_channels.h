// dab_channels.h — DAB Band III channel table for the SDR++ UI dropdown.
//
// Frequencies in Hz, from ETSI EN 300 401, Band III only (5A..13F).
// Band L is not used in Europe and is omitted for simplicity.
...
inline const std::vector<DabChannel>& bandIIIChannels() {
    static const std::vector<DabChannel> chans = {
